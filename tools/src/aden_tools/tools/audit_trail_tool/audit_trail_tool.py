...
def get_latest_run_id(agent_name: str) -> Optional[str]:
...
def get_audit_trail(agent_name: str, run_id: Optional[str] = "latest") -> str:
    """
...
def register_tools(mcp: FastMCP, credentials: Optional[Any] = None) -> None:
